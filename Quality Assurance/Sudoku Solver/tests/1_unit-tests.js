...
suite('UnitTests', () => {
  ...
  test('Logic handles a puzzle string with invalid characters (not 1-9 or .)', (done) => {
    let puzzleString =
      '1.e..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.wt...8..1..16....926914.37.';
    assert.equal(solver.validate(puzzleString), 'Invalid characters in puzzle');
    done();
  });
  test('Logic handles a puzzle string that is not 81 characters in length', (done) => {
    let puzzleString =
      '1.e..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.wt...8..1..16....926914.37..8182121';
    assert.equal(
  ...
  test('Invalid puzzle strings fail the solver', (done) => {
    let puzzleString =
      '1.5..5.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.';
