  ...
  suite('POST request to /api/solve', () => {
    ...
    test('Solve a puzzle with invalid characters', (done) => {
      chai
        ...
        .send({
          puzzle:
            '..9..a.e.fg.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..',
        })
        .end((err, res) => {
    ...
    test('Solve a puzzle with incorrect length', (done) => {
      chai
        ...
        .send({
          puzzle:
            '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6....4',
        })
        .end((err, res) => {
  ...
  suite(' POST request to /api/check', () => {
    ...
    test('Check a puzzle placement with invalid characters', (done) => {
      chai
        ...
        .send({
          puzzle:
            '..9..5.1.ac.e....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..',
          coordinate: 'D2',
          value: '3',
        })
        .end((err, res) => {
